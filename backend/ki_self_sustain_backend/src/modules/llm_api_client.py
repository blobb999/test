...
class LLMAPIClient:
    ...
    def chat_completion(self, messages, model="tinyllama", temperature=0.7, max_tokens=1000):
    ...
    def simple_completion(self, prompt, model="tinyllama", temperature=0.7, max_tokens=1000):
